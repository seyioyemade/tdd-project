...
#  :open_book: tdd-project <a name="about-project"></a>
tdd-project is a ruby project to practice Test-driven Development
...
```
git clone https://github.com/seyioyemade/tdd-project.git
```
...
Feel free to check the [issues page](https://github.com/seyioyemade/tdd-project/issues).
